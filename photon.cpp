...
// FIXME:
//      - call 'currLayer->getAbsorber(currLocation)' and return pointer to absorber.
//          - if p_absorber == NULL, get 'mu_a' and 'mu_s' from layer
//          - otherwise get from absorber, calculate absorbed energy and pass back to 
//          - p_absorber.
//      - Back to Big0(n).
void Photon::drop()
{
